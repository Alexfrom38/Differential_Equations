...
bool IsGoodTime(int i)
{
	if (i / 100000 == 0 && i % 10 == 0 && (i / 10) % 10 == 0 && (i / 100) % 10 == 0 && (i / 1000) % 10 == 0 &&
		((i / 10000) % 10 == 1 || (i / 10000) % 10 == 2 || (i / 10000) % 10 == 3 || (i / 10000) % 10 == 4 || (i / 10000) % 10 == 5 || (i / 10000) % 10 == 6 ||
			(i / 10000) % 10 == 7 || (i / 10000) % 10 == 8 || (i / 10000) % 10 == 9 || (i / 10000) % 10 == 0))
		return true;
	else
		return false;
}
